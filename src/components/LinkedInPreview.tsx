...
export default function LinkedInPreview({
  ...
  return (
    <div className="w-full max-w-[520px] mx-auto" role="region" aria-label="LinkedIn post preview">
      <div className="rounded-lg border border-zinc-700/50 bg-zinc-900 shadow-xl">
        {/* Header */}
        <div className="flex items-start gap-3 p-4 pb-2">
          <div className="h-12 w-12 flex-shrink-0 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-white font-bold text-lg" aria-hidden="true">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-zinc-500 mt-0.5 flex items-center gap-1">
              Just now · <span aria-hidden="true">🌐</span>
            </p>
          </div>
          <button className="text-indigo-400 text-sm font-semibold hover:text-indigo-300" aria-label="Follow this author">
            + Follow
          </button>
        </div>
        ...
        {/* Action Buttons */}
        <div className="flex items-center justify-around border-t border-zinc-800 px-2 py-1" role="group" aria-label="Post engagement actions">
          {[
